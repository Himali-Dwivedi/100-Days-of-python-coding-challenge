...
while is_game_continued == True:
    ...
    if(shift_number < 0 or shift_number > 19):
    ...
    if(action.lower() == "encode"):
        ...
        for char in user_input:
            if char in small_letters:
                ...
                if new_index >= len(small_letters):
                    looped_index = new_index - (len(small_letters))
                    encrypted_message += small_letters[looped_index];
                else:
                ...
                new_index = index + shift_number;
                if new_index >= len(capital_letters):
                    looped_index = new_index - (len(capital_letters))
                    encrypted_message += capital_letters[looped_index];
                else:
                ...
                if new_index >= len(numbers):
                    looped_index = new_index - (len(numbers))
                    encrypted_message += numbers[looped_index];
                else:
                ...
                new_index = index + shift_number;
                if new_index >= len(special_characters):
                    looped_index = new_index - (len(special_characters))
                    encrypted_message += special_characters[looped_index];
                else:
        ...
        for char in user_input:
            if char in small_letters:
                ...
                new_index = index - shift_number;
                if new_index < 0:
                    looped_index = len(small_letters) + new_index;
                    decrypted_message += small_letters[looped_index];
                else:
                ...
                new_index = index - shift_number;
                if new_index < 0:
                    looped_index = len(capital_letters) + new_index;
                    decrypted_message += capital_letters[looped_index];
                else:
                ...
                new_index = index - shift_number;
                if new_index < 0:
                    looped_index = len(numbers) + new_index;
                    decrypted_message += numbers[looped_index];
                else:
                ...
                new_index = index - shift_number;
                if new_index < 0:
                    looped_index = len(special_characters) + new_index;
                    decrypted_message += special_characters[looped_index];
                else:
